/**
 * Credits
 * This code is from an example project by Vercel. All credit goes to original code authors.
 *
 * Project Link: https://github.com/vercel/examples/blob/main/edge-functions/geolocation/lib/countries.json
 */
