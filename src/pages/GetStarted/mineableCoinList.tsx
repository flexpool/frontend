      ...
      },
      {
        ...
        miners: [
          ...
          },
          {
            ...
            compatibleGpus: ['AMD'],
            downloadLink: 'https://github.com/todxx/teamredminer/releases',
            cmd: 'teamredminer.exe -a ironfish -o stratum+tcp://iron.fpmp.net:8888 -u MAIN_WALLET_ADDRESS.WORKER_NAME -p x --zil -o zmp://zil.flexpool.io -u DUAL_WALLET_ADDRESS.WORKER_NAME -p x --zil_end --fan_control',
          },
        ],
      },
    ],
